...
import sensirion_shdlc_sensorbridge

# -- Project information -----------------------------------------------------

project = u'Sensirion SEK-SensorBridge Python Driver'
copyright = u'{} Sensirion AG, Switzerland'.format(datetime.now().year)
author = u'Sensirion AG'


# The short X.Y version
version = sensirion_shdlc_sensorbridge.__version__
# The full version, including alpha/beta/rc tags
release = sensirion_shdlc_sensorbridge.__version__
...
htmlhelp_basename = 'PythonDriverforSensirionSekSensorBridge'
...
latex_documents = [
    (
        master_doc,
        'PythonDriverforSensirionSekSensorBridge.tex',
        u'Python Driver for Sensirion SEK-SensorBridge Documentation',
        u'Sensirion AG',
        'manual'
    ),
]
...
man_pages = [
    (
        master_doc,
        'pythondriverforsensirionseksensorbridge',
        u'Python Driver for Sensirion SEK-SensorBridge Documentation',
        [author],
        1
    )
